# Previously this file was having the simple calculator but we now updated it with the expense tracker code the previous file server is already uploaded on the fastmcp.cloud so no worries
# but we also upodated the fastmcp.cloud with this so we dont have it now! 
